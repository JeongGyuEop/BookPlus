...
사용자가 다음을 클릭하면 <hidden>태그의 상품정보를 자바스크립트 함수로 전달하여 이미지를 표시합니다.
 --%>
	<div id="sticky">
		<ul>
			<li>
				<!-- 페이스북: 페이스북 공식 홈페이지로 이동 --> <a href="https://www.facebook.com"
				target="_blank"> <img width="24" height="24"
					src="${contextPath}/resources/image/facebook_icon.png"> 페이스북
			</a>
			</li>
			<li>
				<!-- 트위터: 트위터 공식 홈페이지로 이동 --> <a href="https://www.twitter.com"
				target="_blank"> <img width="24" height="24"
					src="${contextPath}/resources/image/twitter_icon.png"> 트위터
			</a>
			</li>
			<li>
				<!-- RSS 피드: 원하는 RSS 피드 URL로 이동 --> <a href="https://www.rss.com"
				target="_blank"> <img width="24" height="24"
				...
				<c:choose>
					...
					<c:otherwise>
						<form name="frm_sticky">
							...
							<c:forEach var="item" items="${sessionScope.quickGoodsList }"
								varStatus="itemNum">
								<c:choose>
				...
				<c:otherwise>
					<h5>
						<a href='javascript:fn_show_previous_goods();'> 이전 </a> &nbsp; <span
							id="cur_goods_num">1</span>/${sessionScope.quickGoodsListNum}
