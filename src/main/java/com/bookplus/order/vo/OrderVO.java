...
public class OrderVO {
	private int order_seq_num; // 주문 상품 일련번호
	private int order_id;	  // 주문 번호
	private String member_id;  //주문자 아이디

	// 변경 사항 반영
	private String goods_isbn;       // 기존 goods_id(int) → goods_isbn(String)
	private String goods_title;      // 상품 이름
	private int goods_priceSales;    // 기존 goods_sales_price → goods_priceSales
	...
	// 변경 사항 반영
	private String goods_cover; // 기존 goods_fileName → goods_cover
