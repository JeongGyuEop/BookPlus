package com.bookplus.common.log;
...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.bookplus.*.service.*.*(..)) or "
			+ "execution(* com.bookplus.*.dao.*.*(..))")
	...
	@After("execution(* com.bookplus.*.service.*.*(..)) or "
			+ "execution(* com.bookplus.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.bookplus.*.service.*.*(..)) or "
			+ "execution(* com.bookplus.*.dao.*.*(..))")
