			...
			<div class="tab_container">
				...
				<div class="tab_content" id="tab1">
					<table>
						...
						<tr>
							<td>정가(standard)</td>
							<td><input name="goods_priceStandard" type="text" size="40" /></td>
						</tr>
						<tr>
							<td>판매가(sales)</td>
							<td><input name="goods_priceSales" type="text" size="40" /></td>
						</tr>
						<tr>
							<td>적립 포인트</td>
						...
						<tr>
							<td>출판일(pubDate)</td>
							<td><input name="goods_pubDate" type="date" size="40" /></td>
						</tr>
						<tr>
							<td>총 페이지 수</td>
				...
				<!-- 상품저자소개 (goods_writer_intro → goods_author_intro) -->
				<div class="tab_content" id="tab3">
					<H4>상품 저자 소개</H4>
					<table>
						<tr>
							<td>상품 저자 소개</td>
							<td><textarea rows="100" cols="80" name="goods_author_intro"></textarea></td>
						</tr>
					</table>
				</div>
