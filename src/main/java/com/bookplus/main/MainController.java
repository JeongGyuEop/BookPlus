...
public class MainController extends BaseController {
	...
	public ModelAndView main(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// ViewNameIntercetor클래스의 preHandle메소드 내부에서 request에 바인딩한 뷰 주소 /main/main
		// 을!!!!!!!
		// request.getAttribute("viewName"); 으로 얻어
		// views폴더/main폴더/main.jsp메인 페이지로 조회된 베스트셀러 , 신간, 스테디셀러 도서 정보를 보내기 위해
		// ModelAndView객체에 저장 (바인딩)
		...
		System.out.println(
				" Map<String,List<GoodsVO>> goodsMap=goodsService.listGoods(); 이코드에 의해 베스드셀러 신간, 스테디셀러 정보를 조회해 Map에 저장 후 반환 받습니다.");
