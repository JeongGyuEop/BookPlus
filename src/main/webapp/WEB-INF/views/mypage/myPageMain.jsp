...
<%--
		...
		주문 할때마다 여러 개의 상품을 주문할수 있으므로  
		이중<forEach>태그를 이용해 주문 당 해당 상품들이표시되도록 설정함
 --%>
...
function fn_cancel_order(order_id){
	...
	if(answer==true){
	    ...
	    /*
	    <body>
	    	<form action="${contextPath}/mypage/cancelMyOrder.do" method="post">
	    	
	    		<input type="text" name="order_id"  value="취소할주문번호" >
