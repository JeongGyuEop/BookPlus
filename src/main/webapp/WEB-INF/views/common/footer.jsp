...
<ul>
    ...
    <li class="no_line"><a href="${contextPath}/map/directions.do">찾아오시는길</a></li>
</ul>
<div class="clear"></div>
<a href="#"><img width="147px" height="62px" alt="Booktopia" src="${contextPath}/resources/image/bookplus.png" /></a>
